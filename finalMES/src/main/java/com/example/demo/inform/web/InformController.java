...
public class InformController {
	...
	@ResponseBody
	public String checkPassword(HttpServletRequest request, @RequestParam("userPassword") String userPassword) {
		// 세션에서 userCode 가져오기
	...
	@ResponseBody
	public String ResetPass(@RequestBody EmpVO empVO) {
		String msg;
		String encodedPassword = passwordEncoder.encode("1234");
		empVO.setUserPassword(encodedPassword);
		System.out.println("userCode : " + empVO.getUserCode());
		informService.updateResetPass(empVO);
		msg = "비밀번호가 초기화 되었습니다.";
		return msg;
	}
	...
	@ResponseBody
	public String deleteEmp(@RequestBody String userCode) {
		String msg;
		System.out.println("userCode : " + userCode);
		informService.deleteEmp(userCode);
		msg = "사원 정보가 삭제 되었습니다.";
		return msg;
	}
	...
	@DeleteMapping("/matInfoDelete")
	@ResponseBody
	public String deleteMat(@RequestBody String matCode) {
		String msg;
		informService.deleteMat(matCode);
		msg = "자재 정보가 삭제 되었습니다.";
		return msg;
	}
	...
	@DeleteMapping("/prodInfoDelete")
	@ResponseBody
	public String deleteProd(@RequestBody String prodCode) {
		String msg;
		informService.deleteProd(prodCode);
		msg = "제품 정보가 삭제 되었습니다.";
		return msg;
	}
	...
	@DeleteMapping("/procInfoDelete")
	@ResponseBody
	public String deleteProc(@RequestBody String procCode) {
		String msg;
		informService.deleteProc(procCode);
		msg = "공정 정보가 삭제 되었습니다.";
		return msg;
	}
	...
	@DeleteMapping("/badMatDelete")
	@ResponseBody
	public String deleteBadMat(@RequestBody String badMatCode) {
		String msg;
		informService.deleteBad(badMatCode);
		msg = "불량 정보가 삭제 되었습니다.";
		return msg;
	}
